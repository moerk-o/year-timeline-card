 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const st={attribute:!0,type:String,converter:J,reflect:!1,hasChanged:re},rt=(s=st,e,t)=>{const{kind:r,metadata:a}=t;let i=globalThis.litPropertyMetadata.get(a);if(i===void 0&&globalThis.litPropertyMetadata.set(a,i=new Map),r==="setter"&&((s=Object.create(s)).wrapped=!0),i.set(t.name,s),r==="accessor"){const{name:n}=t;return{set(o){const l=e.get.call(this);e.set.call(this,o),this.requestUpdate(n,l,s,!0,o)},init(o){return o!==void 0&&this.C(n,void 0,s,o),o}}}if(r==="setter"){const{name:n}=t;return function(o){const l=this[n];e.call(this,o),this.requestUpdate(n,l,s,!0,o)}}throw Error("Unsupported decorator location: "+r)};function m(s){return(e,t)=>typeof t=="object"?rt(s,e,t):((r,a,i)=>{const n=a.hasOwnProperty(i);return a.constructor.createProperty(i,r),n?Object.getOwnPropertyDescriptor(a,i):void 0})(s,e,t)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,lt=["year","dayOfYear","isoWeek","quarter"],O={segments:"months",labels:"quarters",showTodayMarker:!0,showProgressFill:!0,progressColor:null},Q={borderless:!1,compactFacts:!1,factsColumns:2},ct="auto",E={type:"point",showOnBar:!0,showInList:!0};function ht(s){if(!s||!s.show)return lt;const e=s.show;return Array.isArray(e)?e.filter(r=>dt(r)):["year","dayOfYear","isoWeek","month","quarter","progress","remainingDays"].filter(r=>e[r]===!0)}function dt(s){return typeof s=="string"&&["year","dayOfYear","isoWeek","month","quarter","progress","remainingDays"].includes(s)}function ut(s){return s?{segments:mt(s.segments),labels:gt(s.labels),showTodayMarker:s.show_today_marker??O.showTodayMarker,showProgressFill:s.show_progress_fill??O.showProgressFill,progressColor:s.progress_color??O.progressColor}:O}function pt(s){return s?{borderless:s.borderless??Q.borderless,compactFacts:s.compact_facts??Q.compactFacts,factsColumns:s.facts_columns??Q.factsColumns}:Q}function mt(s){return s&&["none","quarters","months","weeks"].includes(s)?s:O.segments}function gt(s){return s&&["none","quarters","months"].includes(s)?s:O.labels}function ft(s){var a;if(!s.entity||typeof s.entity!="string")return null;let e="state";if(s.source&&s.source!=="state"){const i=/^attribute:(.+)$/.exec(s.source);i&&i[1]&&(e={attribute:i[1]})}const r=["point","rangeStart","rangeEnd","range"].includes(s.type)?s.type:E.type;return{entity:s.entity,label:((a=s.label)==null?void 0:a.trim())||null,source:e,type:r,showOnBar:s.showOnBar??E.showOnBar,showInList:s.showInList??E.showInList}}function yt(s){if(!s||!Array.isArray(s))return[];const e=[];for(const t of s){const r=ft(t);r&&e.push(r)}return e}function _t(s){return{title:s.title??null,locale:s.locale??ct,layout:pt(s.layout),facts:ht(s.facts),bar:ut(s.bar),markers:yt(s.markers)}}function bt(s){if(!s||typeof s!="object")return!1;const e=s;return typeof e.type=="string"&&e.type==="custom:year-timeline-card"}function $t(s){return s%4===0&&s%100!==0||s%400===0}function Ce(s){return $t(s)?366:365}function Ee(s){const e=new Date(s.getFullYear(),0,0),t=s.getTime()-e.getTime(),r=1e3*60*60*24;return Math.floor(t/r)}function vt(s){const e=new Date(s.valueOf()),t=(s.getDay()+6)%7;e.setDate(e.getDate()-t+3);const r=new Date(e.getFullYear(),0,4),a=(r.getDay()+6)%7;r.setDate(r.getDate()-a+3);const i=e.getTime()-r.getTime();return 1+Math.round(i/6048e5)}function wt(s){return Math.floor(s.getMonth()/3)+1}function le(s){const e=s.getFullYear(),t=new Date(e,0,1).getTime(),r=new Date(e+1,0,1).getTime(),i=(s.getTime()-t)/(r-t)*100;return Math.min(100,Math.max(0,i))}function kt(s){const e=s.getFullYear(),t=Ce(e),r=Ee(s);return t-r}function xt(s){if(s instanceof Date)return isNaN(s.getTime())?null:s;if(typeof s!="string"||s.trim()==="")return null;const e=s.trim(),t=new Date(e);if(!isNaN(t.getTime()))return t;const r=[{regex:/^(\d{4})-(\d{1,2})-(\d{1,2})$/,parse:a=>new Date(parseInt(a[1]),parseInt(a[2])-1,parseInt(a[3]))},{regex:/^(\d{1,2})\.(\d{1,2})\.(\d{4})$/,parse:a=>new Date(parseInt(a[3]),parseInt(a[2])-1,parseInt(a[1]))},{regex:/^(\d{1,2})\/(\d{1,2})\/(\d{4})$/,parse:a=>new Date(parseInt(a[3]),parseInt(a[1])-1,parseInt(a[2]))}];for(const{regex:a,parse:i}of r){const n=e.match(a);if(n){const o=i(n);if(!isNaN(o.getTime()))return o}}return null}const Me={de:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"],en:["January","February","March","April","May","June","July","August","September","October","November","December"]},Se={de:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],en:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]};function De(s,e,t=!1){return(t?Se[e]??Se.de:Me[e]??Me.de)[s]??""}function At(s){return s==="en"?"CW":"KW"}function Ct(s,e){if(s==="none")return[];const t=new Date(e,0,1).getTime(),a=new Date(e+1,0,1).getTime()-t,i=n=>(n.getTime()-t)/a*100;if(s==="quarters")return[0,i(new Date(e,3,1)),i(new Date(e,6,1)),i(new Date(e,9,1))];if(s==="months"){const n=[];for(let o=0;o<12;o++)n.push(i(new Date(e,o,1)));return n}if(s==="weeks"){const n=[],l=(new Date(e,0,1).getDay()+6)%7;let u;l<=3?u=new Date(e,0,1-l):u=new Date(e,0,8-l);let p=u;for(;p.getFullYear()<=e;){const h=i(p);h>=0&&h<100&&n.push(h),p=new Date(p.getTime()+6048e5)}return n}return[]}function Et(s,e,t){if(s==="none")return[];const r=new Date(e,0,1).getTime(),i=new Date(e+1,0,1).getTime()-r,n=o=>(o.getTime()-r)/i*100;if(s==="quarters")return[{position:n(new Date(e,1,1)),label:"Q1"},{position:n(new Date(e,4,1)),label:"Q2"},{position:n(new Date(e,7,1)),label:"Q3"},{position:n(new Date(e,10,1)),label:"Q4"}];if(s==="months"){const o=[];for(let l=0;l<12;l++){const u=new Date(e,l,1),p=new Date(e,l+1,1),h=new Date((u.getTime()+p.getTime())/2);o.push({position:n(h),label:De(l,t,!0)})}return o}return[]}function Mt(s,e){return e==="state"?s.state:s.attributes[e.attribute]}function St(s,e){return s.label?s.label:e.attributes.friendly_name??s.entity}function Dt(s,e,t){const r=e[s.entity];if(!r)return null;const a=Mt(r,s.source),i=xt(a);if(!i||i.getFullYear()!==t)return null;const n=le(i);return{label:St(s,r),date:i,position:n,type:s.type,showOnBar:s.showOnBar,showInList:s.showInList}}function Lt(s,e,t){const r=[];for(const a of s){const i=Dt(a,e,t);i&&r.push(i)}return r.sort((a,i)=>a.position-i.position),r}function Ot(s,e){const t=s.getDate(),r=s.getMonth()+1;return e==="en"?`${r}/${t}`:`${t}.${r}.`}var Tt=Object.defineProperty,Pt=Object.getOwnPropertyDescriptor,T=(s,e,t,r)=>{for(var a=r>1?void 0:r?Pt(e,t):e,i=s.length-1,n;i>=0;i--)(n=s[i])&&(a=(r?n(e,t,a):n(a))||a);return r&&a&&Tt(e,t,a),a};let $=class extends f{constructor(){super(...arguments),this.progress=0,this.year=new Date().getFullYear(),this.locale="de",this.config={segments:"months",labels:"quarters",showTodayMarker:!0,showProgressFill:!0},this.markers=[]}render(){return c`
    ...
    `}renderMarker(s){const e=Math.min(100,Math.max(0,s.position));let t="";return s.type==="rangeStart"?t="range-start":s.type==="rangeEnd"&&(t="range-end"),c`
      <div
        ...
        title="${s.label}"
      ></div>
    `}};$.styles=it,T([m({type:Number})],$.prototype,"progress",2),T([m({type:Number})],$.prototype,"year",2),T([m({type:String})],$.prototype,"locale",2),T([m({type:Object})],$.prototype,"config",2),T([m({type:Array})],$.prototype,"markers",2),$=T([Y("ytc-timeline-bar")],$);var Ft=Object.defineProperty,It=Object.getOwnPropertyDescriptor,P=(s,e,t,r)=>{for(var a=r>1?void 0:r?It(e,t):e,i=s.length-1,n;i>=0;i--)(n=s[i])&&(a=(r?n(e,t,a):n(a))||a);return r&&a&&Ft(e,t,a),a};const Le={de:{year:"Jahr",dayOfYear:"Tag",isoWeek:"Kalenderwoche",month:"Monat",quarter:"Quartal",progress:"Fortschritt",remainingDays:"Resttage"},en:{year:"Year",dayOfYear:"Day",isoWeek:"Week",month:"Month",quarter:"Quarter",progress:"Progress",remainingDays:"Days left"}};let v=class extends f{constructor(){super(...arguments),this.date=new Date,this.facts=[],this.locale="de",this.compact=!1,this.columns=2}render(){if(this.facts.length===0)return c``;const s=`
    ...
    `}getLabel(s){return(Le[this.locale]??Le.de)[s]}getValue(s){const e=this.date.getFullYear();switch(s){case"year":return String(e);case"dayOfYear":{const t=Ee(this.date),r=Ce(e);return`${t} / ${r}`}case"isoWeek":{const t=vt(this.date);return`${At(this.locale)} ${t}`}case"month":{const t=this.date.getMonth();return De(t,this.locale,!1)}case"quarter":return`Q${wt(this.date)}`;case"progress":return`${le(this.date).toFixed(1)}%`;case"remainingDays":{const t=kt(this.date);return String(t)}default:return null}}};v.styles=nt,P([m({type:Object})],v.prototype,"date",2),P([m({type:Array})],v.prototype,"facts",2),P([m({type:String})],v.prototype,"locale",2),P([m({type:Boolean})],v.prototype,"compact",2),P([m({type:Number})],v.prototype,"columns",2),v=P([Y("ytc-facts-block")],v);var Ht=Object.defineProperty,Nt=Object.getOwnPropertyDescriptor,ce=(s,e,t,r)=>{for(var a=r>1?void 0:r?Nt(e,t):e,i=s.length-1,n;i>=0;i--)(n=s[i])&&(a=(r?n(e,t,a):n(a))||a);return r&&a&&Ht(e,t,a),a};const Oe={de:"Ereignisse",en:"Events"};let j=class extends f{constructor(){super(...arguments),this.markers=[],this.locale="de"}render(){const s=this.markers.filter(t=>t.showInList);if(s.length===0)return d;const e=Oe[this.locale]??Oe.de;return c`
    ...
    `}_renderFactsSection(){var i,n;const s=this._getLabels(),e=this._getLocale(),t=Te[e]??Te.de,r=((n=(i=this._config)==null?void 0:i.facts)==null?void 0:n.show)??["year","dayOfYear","isoWeek","quarter"],a=Rt.filter(o=>!r.includes(o));return c`
