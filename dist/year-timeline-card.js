...
`,lt=["year","dayOfYear","isoWeek","quarter"],R={segments:"months",labels:"quarters",showTodayMarker:!0,showProgressFill:!0},ct="de",M={type:"point",showOnBar:!0,showInList:!0};function ht(r){if(!r||!r.show)return lt;const e=r.show;return Array.isArray(e)?e.filter(s=>dt(s)):["year","dayOfYear","isoWeek","month","quarter","progress","remainingDays"].filter(s=>e[s]===!0)}function dt(r){return typeof r=="string"&&["year","dayOfYear","isoWeek","month","quarter","progress","remainingDays"].includes(r)}function pt(r){return r?{segments:ut(r.segments),labels:mt(r.labels),showTodayMarker:r.show_today_marker??R.showTodayMarker,showProgressFill:r.show_progress_fill??R.showProgressFill}:R}function ut(r){return r&&["none","quarters","months","weeks"].includes(r)?r:R.segments}function mt(r){return r&&["none","quarters","months"].includes(r)?r:R.labels}function ft(r){var i;if(!r.entity||typeof r.entity!="string")return null;let e="state";if(r.source&&r.source!=="state"){const n=/^attribute:(.+)$/.exec(r.source);n&&n[1]&&(e={attribute:n[1]})}const s=["point","rangeStart","rangeEnd","range"].includes(r.type)?r.type:M.type;return{entity:r.entity,label:((i=r.label)==null?void 0:i.trim())||null,source:e,type:s,showOnBar:r.showOnBar??M.showOnBar,showInList:r.showInList??M.showInList}}function gt(r){if(!r||!Array.isArray(r))return[];const e=[];for(const t of r){const s=ft(t);s&&e.push(s)}return e}function yt(r){return{title:r.title??null,locale:r.locale??ct,facts:ht(r.facts),bar:pt(r.bar),markers:gt(r.markers)}}function _t(r){if(!r||typeof r!="object")return!1;const e=r;return typeof e.type=="string"&&e.type==="custom:year-timeline-card"}function $t(r){return r%4===0&&r%100!==0||r%400===0}function xe(r){return $t(r)?366:365}function Me(r){const e=new Date(r.getFullYear(),0,0),t=r.getTime()-e.getTime(),s=1e3*60*60*24;return Math.floor(t/s)}function vt(r){const e=new Date(r.valueOf()),t=(r.getDay()+6)%7;e.setDate(e.getDate()-t+3);const s=new Date(e.getFullYear(),0,4),i=(s.getDay()+6)%7;s.setDate(s.getDate()-i+3);const n=e.getTime()-s.getTime();return 1+Math.round(n/6048e5)}function bt(r){return Math.floor(r.getMonth()/3)+1}function oe(r){const e=r.getFullYear(),t=new Date(e,0,1).getTime(),s=new Date(e+1,0,1).getTime(),n=(r.getTime()-t)/(s-t)*100;return Math.min(100,Math.max(0,n))}function wt(r){const e=r.getFullYear(),t=xe(e),s=Me(r);return t-s}function kt(r){if(r instanceof Date)return isNaN(r.getTime())?null:r;if(typeof r!="string"||r.trim()==="")return null;const e=r.trim(),t=new Date(e);if(!isNaN(t.getTime()))return t;const s=[{regex:/^(\d{4})-(\d{1,2})-(\d{1,2})$/,parse:i=>new Date(parseInt(i[1]),parseInt(i[2])-1,parseInt(i[3]))},{regex:/^(\d{1,2})\.(\d{1,2})\.(\d{4})$/,parse:i=>new Date(parseInt(i[3]),parseInt(i[2])-1,parseInt(i[1]))},{regex:/^(\d{1,2})\/(\d{1,2})\/(\d{4})$/,parse:i=>new Date(parseInt(i[3]),parseInt(i[1])-1,parseInt(i[2]))}];for(const{regex:i,parse:n}of s){const a=e.match(i);if(a){const o=n(a);if(!isNaN(o.getTime()))return o}}return null}const Se={de:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"],en:["January","February","March","April","May","June","July","August","September","October","November","December"]},Ee={de:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],en:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]};function Ce(r,e,t=!1){return(t?Ee[e]??Ee.de:Se[e]??Se.de)[r]??""}function At(r){return r==="en"?"CW":"KW"}function xt(r,e){if(r==="none")return[];const t=new Date(e,0,1).getTime(),i=new Date(e+1,0,1).getTime()-t,n=a=>(a.getTime()-t)/i*100;if(r==="quarters")return[0,n(new Date(e,3,1)),n(new Date(e,6,1)),n(new Date(e,9,1))];if(r==="months"){const a=[];for(let o=0;o<12;o++)a.push(n(new Date(e,o,1)));return a}if(r==="weeks"){const a=[],l=(new Date(e,0,1).getDay()+6)%7;let p;l<=3?p=new Date(e,0,1-l):p=new Date(e,0,8-l);let u=p;for(;u.getFullYear()<=e;){const h=n(u);h>=0&&h<100&&a.push(h),u=new Date(u.getTime()+6048e5)}return a}return[]}function Mt(r,e,t){if(r==="none")return[];const s=new Date(e,0,1).getTime(),n=new Date(e+1,0,1).getTime()-s,a=o=>(o.getTime()-s)/n*100;if(r==="quarters")return[{position:a(new Date(e,1,1)),label:"Q1"},{position:a(new Date(e,4,1)),label:"Q2"},{position:a(new Date(e,7,1)),label:"Q3"},{position:a(new Date(e,10,1)),label:"Q4"}];if(r==="months"){const o=[];for(let l=0;l<12;l++){const p=new Date(e,l,1),u=new Date(e,l+1,1),h=new Date((p.getTime()+u.getTime())/2);o.push({position:a(h),label:Ce(l,t,!0)})}return o}return[]}function St(r,e){return e==="state"?r.state:r.attributes[e.attribute]}function Et(r,e){return r.label?r.label:e.attributes.friendly_name??r.entity}function Ct(r,e,t){const s=e[r.entity];if(!s)return null;const i=St(s,r.source),n=kt(i);if(!n||n.getFullYear()!==t)return null;const a=oe(n);return{label:Et(r,s),date:n,position:a,type:r.type,showOnBar:r.showOnBar,showInList:r.showInList}}function Ot(r,e,t){const s=[];for(const i of r){const n=Ct(i,e,t);n&&s.push(n)}return s.sort((i,n)=>i.position-n.position),s}function Tt(r,e){const t=r.getDate(),s=r.getMonth()+1;return e==="en"?`${s}/${t}`:`${t}.${s}.`}var Dt=Object.defineProperty,Pt=Object.getOwnPropertyDescriptor,T=(r,e,t,s)=>{for(var i=s>1?void 0:s?Pt(e,t):e,n=r.length-1,a;n>=0;n--)(a=r[n])&&(i=(s?a(e,t,i):a(i))||i);return s&&i&&Dt(e,t,i),i};let v=class extends g{constructor(){super(...arguments),this.progress=0,this.year=new Date().getFullYear(),this.locale="de",this.config={segments:"months",labels:"quarters",showTodayMarker:!0,showProgressFill:!0},this.markers=[]}render(){return c`
    ...
    `}renderSegments(){const r=xt(this.config.segments,this.year);if(r.length===0)return c``;const e=this.config.segments==="weeks";return c`
    ...
    `}renderMarker(r){const e=Math.min(100,Math.max(0,r.position));let t="";return r.type==="rangeStart"?t="range-start":r.type==="rangeEnd"&&(t="range-end"),c`
      <div
        ...
        title="${r.label}"
      ></div>
    `}};v.styles=nt,T([m({type:Number})],v.prototype,"progress",2),T([m({type:Number})],v.prototype,"year",2),T([m({type:String})],v.prototype,"locale",2),T([m({type:Object})],v.prototype,"config",2),T([m({type:Array})],v.prototype,"markers",2),v=T([B("ytc-timeline-bar")],v);var Lt=Object.defineProperty,Ft=Object.getOwnPropertyDescriptor,Q=(r,e,t,s)=>{for(var i=s>1?void 0:s?Ft(e,t):e,n=r.length-1,a;n>=0;n--)(a=r[n])&&(i=(s?a(e,t,i):a(i))||i);return s&&i&&Lt(e,t,i),i};const Oe={de:{year:"Jahr",dayOfYear:"Tag",isoWeek:"Kalenderwoche",month:"Monat",quarter:"Quartal",progress:"Fortschritt",remainingDays:"Resttage"},en:{year:"Year",dayOfYear:"Day",isoWeek:"Week",month:"Month",quarter:"Quarter",progress:"Progress",remainingDays:"Days left"}};let D=class extends g{constructor(){super(...arguments),this.date=new Date,this.facts=[],this.locale="de"}render(){return this.facts.length===0?c``:c`
    ...
    `}getLabel(r){return(Oe[this.locale]??Oe.de)[r]}getValue(r){const e=this.date.getFullYear();switch(r){case"year":return String(e);case"dayOfYear":{const t=Me(this.date),s=xe(e);return`${t} / ${s}`}case"isoWeek":{const t=vt(this.date);return`${At(this.locale)} ${t}`}case"month":{const t=this.date.getMonth();return Ce(t,this.locale,!1)}case"quarter":return`Q${bt(this.date)}`;case"progress":return`${oe(this.date).toFixed(1)}%`;case"remainingDays":{const t=wt(this.date);return String(t)}default:return null}}};D.styles=at,Q([m({type:Object})],D.prototype,"date",2),Q([m({type:Array})],D.prototype,"facts",2),Q([m({type:String})],D.prototype,"locale",2),D=Q([B("ytc-facts-block")],D);var It=Object.defineProperty,Nt=Object.getOwnPropertyDescriptor,le=(r,e,t,s)=>{for(var i=s>1?void 0:s?Nt(e,t):e,n=r.length-1,a;n>=0;n--)(a=r[n])&&(i=(s?a(e,t,i):a(i))||i);return s&&i&&It(e,t,i),i};const Te={de:"Ereignisse",en:"Events"};let j=class extends g{constructor(){super(...arguments),this.markers=[],this.locale="de"}render(){const r=this.markers.filter(t=>t.showInList);if(r.length===0)return d;const e=Te[this.locale]??Te.de;return c`
    ...
    `}renderMarkerItem(r){const e=Tt(r.date,this.locale);return c`
    ...
    `}_renderFactsSection(){var n,a;const r=this._getLabels(),e=this._getLocale(),t=Pe[e]??Pe.de,s=((a=(n=this._config)==null?void 0:n.facts)==null?void 0:a.show)??["year","dayOfYear","isoWeek","quarter"],i=De.filter(o=>!s.includes(o));return c`
